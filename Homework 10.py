...
class Student:
    ...
    def add_course(self, course_code, course_name, semester):
        ...
        for course in self.courses[semester]:
            cursor.execute("INSERT OR REPLACE INTO courses (student_id, semester, course_code, course_name) VALUES (?, ?, ?, ?)", (self.student_id, semester, course["code"], course["name"]))
    ...
    def save_to_database(self):
        ...
        for semester, courses in self.courses.items():
            for course in courses:
                cursor.execute("INSERT INTO courses (student_id, semester, course_code, course_name) VALUES (?, ?, ?, ?)",(self.student_id, semester, course["code"], course["name"]))
                self.connection.commit()
